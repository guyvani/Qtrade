...
'''
  install googlefinance: pip install googlefinance
...
if __name__ == "__main__":
    ...
    snpret = create_lagged_series(
    	"^GSPC", datetime.datetime(2013,1,10), 
    	datetime.datetime(2017,7,12), lags=5
    )
    ''' 
    # Create a lagged series of the S&P500 US ETF
    snpret = create_lagged_series(
    	"NYSEARCA:SPY", datetime.datetime(2013,1,10), 
    	datetime.datetime(2017,7,12), lags=5
    )
    '''
    print(snpret)
